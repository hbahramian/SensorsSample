...
object CompassHelper {
    ...
    fun calculateMagneticDeclination(latitude: Double, longitude: Double, altitude: Double): Double {
    ...
    fun lowPassFilter(input: List<Float>, output: FloatArray?): FloatArray? {
